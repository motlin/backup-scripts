...
pub struct Args {
    ...
    /// Only clean Git-ignored `node_modules`/ dirs older than this many days. 0 = always clean. [config: `clean_node.days`, default: 7]
    #[arg(long)]
    pub days: Option<u32>,
...
pub async fn run(
    ...
    let roots = resolve_roots(&args.roots, cfg.roots.as_ref(), global_roots, "clean_node")?;
